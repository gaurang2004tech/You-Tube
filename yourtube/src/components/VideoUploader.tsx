...
const VideoUploader = ({ channelId, channelName }: any) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const msg = error?.response?.data?.message || "There was an error uploading your video. Please try again.";
      toast.error(msg);
    } finally {
      setIsUploading(false);
    }
    ...
    <div className="bg-gray-50 rounded-lg p-6">
      ...
      <div className="space-y-4">
        {!videoFile ? (
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-3 bg-white dark:bg-zinc-900 rounded-lg border dark:border-zinc-800">
